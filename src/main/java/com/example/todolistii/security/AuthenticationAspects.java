...
public class AuthenticationAspects {
    ...
    @Pointcut("execution(@com.example.todolistii.annotations.Authenticational * *(..))")
    ...
    public Object around(ProceedingJoinPoint joinPoint) {
        ...
        if (request == null) {
            throw new RuntimeException("Method annotated by @Authenticatinal must have HttpServletRequest argument");
        }
        ...
        return authenticationUtils.performAfterAuthentication(request, userId -> {
            try {
                ...
                throw new RuntimeException("Class with method annotated @Autheticational must have userId field", e);
